# Meridiano · Widgets Elementor v1.1.0
...
- CSS específico en `assets/css/frontend.css`, scopeado bajo `nsfmeridiano-scope` para evitar conflictos.
...
`[nsfmeridiano_demo view="cat" switcher="yes"]`

## Instalación

Subir el ZIP desde **Plugins > Añadir nuevo > Subir plugin**. Luego ir a **Herramientas > Meridiano Demo** para crear páginas de prueba.
