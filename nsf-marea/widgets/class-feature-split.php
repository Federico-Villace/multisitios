...
class Feature_Split extends Widget_Base {
    public function get_name() { return 'nsfmarea_feature_split'; }
    public function get_title() { return esc_html__( 'Destacado imagen + texto', 'nsfmarea-widgets' ); }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control( 'image_width', [ 'label' => 'Ancho imagen %', 'type' => \Elementor\Controls_Manager::SLIDER, 'range' => [ '%' => [ 'min' => 30, 'max' => 75 ] ], 'default' => [ 'size' => 60, 'unit' => '%' ], 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-media' => 'flex-basis: {{SIZE}}%;' ] ] );
        $this->add_responsive_control( 'min_height', [ 'label' => 'Alto mínimo imagen', 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => [ 'px', 'vh' ], 'range' => [ 'px' => [ 'min' => 160, 'max' => 760 ], 'vh' => [ 'min' => 20, 'max' => 90 ] ], 'default' => [ 'size' => 310, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-media img, {{WRAPPER}} .nsfmarea-feature-media .card-img' => 'min-height: {{SIZE}}{{UNIT}};' ] ] );
        $this->add_responsive_control( 'copy_padding', [ 'label' => 'Padding texto', 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%', 'em' ], 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-copy' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
        $this->add_responsive_control( 'text_align', [ 'label' => 'Alineación del texto', 'type' => \Elementor\Controls_Manager::CHOOSE, 'options' => [ 'left' => [ 'title' => 'Izquierda', 'icon' => 'eicon-text-align-left' ], 'center' => [ 'title' => 'Centro', 'icon' => 'eicon-text-align-center' ], 'right' => [ 'title' => 'Derecha', 'icon' => 'eicon-text-align-right' ] ], 'default' => 'center', 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-copy' => 'text-align: {{VALUE}};' ] ] );
        $this->add_responsive_control( 'vertical_align', [ 'label' => 'Alineación vertical', 'type' => \Elementor\Controls_Manager::CHOOSE, 'options' => [ 'flex-start' => [ 'title' => 'Arriba', 'icon' => 'eicon-v-align-top' ], 'center' => [ 'title' => 'Centro', 'icon' => 'eicon-v-align-middle' ], 'flex-end' => [ 'title' => 'Abajo', 'icon' => 'eicon-v-align-bottom' ] ], 'default' => 'center', 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-copy' => 'justify-content: {{VALUE}};' ] ] );
        $this->add_responsive_control( 'gap', [ 'label' => 'Separación', 'type' => \Elementor\Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => 0, 'max' => 80 ] ], 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-split' => 'gap: {{SIZE}}{{UNIT}};' ] ] );
        $this->end_controls_section();
        ...
        $this->add_control( 'text_color', [ 'label' => 'Color texto', 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} .nsfmarea-feature-text' => 'color: {{VALUE}};' ] ] );
        $this->end_controls_section();

        $this->start_controls_section( 'style_typo', [ 'label' => 'Tipografías', 'tab' => \Elementor\Controls_Manager::TAB_STYLE ] );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), [ 'name' => 'title_typo', 'selector' => '{{WRAPPER}} .nsfmarea-feature-title' ] );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), [ 'name' => 'text_typo', 'selector' => '{{WRAPPER}} .nsfmarea-feature-text' ] );
        $this->end_controls_section();
    }
