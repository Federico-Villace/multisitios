# El Destape News · Widgets Elementor v1.1.0
...
- CSS específico en `assets/css/frontend.css`, scopeado bajo `nsfeldestape-scope` para evitar conflictos.
...
`[nsfeldestape_demo view="cat" switcher="yes"]`

## Instalación

Subir el ZIP desde **Plugins > Añadir nuevo > Subir plugin**. Luego ir a **Herramientas > El Destape News Demo** para crear páginas de prueba.
