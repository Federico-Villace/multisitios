...
class Sidebar_Most_Read extends Widget_Base {
    public function get_name() { return 'nsfaurora_sidebar_most_read'; }
    public function get_title() { return esc_html__( 'Sidebar Más Leídas', 'nsfaurora-widgets' ); }
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'title', [ 'label' => esc_html__( 'Título', 'nsfaurora-widgets' ), 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'Lo más leído' ] );
    ...
    protected function render() {
        ...
        $i = 1;
        ?>
        <div class="nsfaurora-scope"><aside class="home-side"><div class="side-block"><h3 class="side-head"><?php echo esc_html( $s['title'] ); ?></h3><ol class="rank-list">
