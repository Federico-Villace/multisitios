...
- CSS específico en `assets/css/frontend.css`, scopeado bajo `nsfcapital-scope` para evitar conflictos.
...
`[nsfcapital_demo view="cat" switcher="yes"]`

## Instalación

Subir el ZIP desde **Plugins > Añadir nuevo > Subir plugin**. Luego ir a **Herramientas >  Demo** para crear páginas de prueba.
